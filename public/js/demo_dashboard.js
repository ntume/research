$(function(){        
    ...
    var jvm_wm = new jvm.WorldMap({container: $('#dashboard-map-seles'),
                                    ...
                                    markerStyle: {initial: {fill: '#3FBAE4',
                                                   stroke: '#3FBAE4'}},
                                    markers: [{latLng: [-26.27, 28.11], name: 'Gauteng - 300'},                                              
                                              {latLng: [-33.22, 21.85], name: 'Western Cape - 250'},
                                              {latLng: [-29.04, 21.85], name: 'Northern Cape - 120'},                                            
                                              {latLng: [-32.29, 26.41], name: 'Eastern Cape - 300'}]
                                });    
    /* END Vector Map */
